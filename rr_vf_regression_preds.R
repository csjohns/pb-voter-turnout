...
raceFE <- makeFEdummies(pb_long_orig$Race) 
colnames(raceFE) <- paste("race", colnames(raceFE), sep = "_")
yearFE <- makeFEdummies(pb_long_orig$year)
colnames(yearFE) <- paste("year", colnames(yearFE), sep = "_")
election_typeFE <- makeFEdummies(pb_long_orig$election_type)
...
# listwide removal of NAs (low)
logit_base_simcf <- turned_out ~ pb + after_pb + compet + election_p + election_pp +
  year_2009 + year_2010 + year_2012 + year_2013 + year_2014 + year_2016 + year_2017 +
  race_B + race_A + race_H + race_U + Female + age + I(age^2) + I(age_at_vote < 18) + 
  medhhinc_10k + college_pct + majmatch + (1 | VANID) + (1 | NYCCD)

pb_long <- extractdata(logit_base_simcf, pb_long, na.rm = T)
...
#######################################################################################################################################
### Formula for simcf
logit_base_form <-  turned_out ~ pb + after_pb + compet + election_p+ election_pp +
  year_2009 + year_2010  + year_2012 + year_2013 + year_2014 +  year_2016 + year_2017 +
  race_B + race_A + race_H + race_U + Female + age + I(age^2) + I(age_at_vote < 18) + 
...
for (i in 1){
  ...
  xhyp <- cfChange(xhyp, "compet", x = mean(pb_long_orig$compet[pb_long_orig$election_type=="g" & pb_long_orig$year == 2013], na.rm = T))
}

for (i in 2){
  xhyp <- cfChange(xhyp, "year_2014", x = 1, xpre = 1, scen = i)
  xhyp <- cfChange(xhyp, "compet", x = mean(pb_long_orig$compet[pb_long_orig$election_type=="g" & pb_long_orig$year == 2014], na.rm = T))
}

for (i in 3){
  xhyp <- cfChange(xhyp, "year_2016", x = 1, xpre = 1, scen = i)
  xhyp <- cfChange(xhyp, "compet", x = mean(pb_long_orig$compet[pb_long_orig$election_type=="g" & pb_long_orig$year == 2016], na.rm = T))
}

for (i in 4){
  xhyp <- cfChange(xhyp, "year_2017", x = 1, xpre = 1, scen = i)
  xhyp <- cfChange(xhyp, "compet", x = mean(pb_long_orig$compet[pb_long_orig$election_type=="g" & pb_long_orig$year == 2017], na.rm = T))
}
...
### Estimated model
logit_race_simcf <- turned_out ~ pb + after_pb + compet + election_p + election_pp +
  year_2009 + year_2010  + year_2012 + year_2013 + year_2014 + year_2016 + year_2017 +
  ...
  # year_2011*race_B *race_A *race_H *race_U +
...
### Formula for simcf
logit_race_form <- turned_out ~ pb + after_pb + compet + election_p + election_pp +
  year_2009 + year_2010 + year_2012 + year_2013 + year_2014 +  year_2016 + year_2017 +
  after_pb*race_B + after_pb*race_A + after_pb*race_H + after_pb*race_U +
  year_2009*race_B + year_2009*race_A + year_2009*race_H + year_2009*race_U +
  year_2010*race_B + year_2010*race_A + year_2010*race_H + year_2010*race_U +
...
logit_majmatch_simcf <- turned_out ~ pb + after_pb + compet + election_p + election_pp +
  year_2009 + year_2010 +  year_2012 + year_2013 + year_2014 +  year_2016 + year_2017 +
  race_B + race_A + race_H + race_U + 
  majmatch*after_pb +
  year_2009*majmatch + year_2010*majmatch +  year_2012*majmatch + year_2013*majmatch + year_2014*majmatch + year_2016*majmatch + year_2017*majmatch +
  Female + age + I(age^2) + I(age_at_vote < 18) + 
...
### Formula for simcf
logit_majmatch_form <-  turned_out ~ pb + after_pb + compet + election_p + election_pp +
  year_2009 + year_2010 + year_2012 + year_2013 + year_2014 +  year_2016 + year_2017 +
  race_B + race_A + race_H + race_U + 
  majmatch*after_pb +
  year_2009*majmatch + year_2010*majmatch + year_2012*majmatch + year_2013*majmatch + year_2014*majmatch + year_2016*majmatch + year_2017*majmatch +
...
logit_gender_simcf <- turned_out ~ pb + after_pb + compet + election_p + election_pp +
  year_2009 + year_2010 + year_2012 + year_2013 + year_2014 +  year_2016 + year_2017 +
  race_B + race_A + race_H + race_U + 
  Female*after_pb +
  year_2009*Female + year_2010*Female  + year_2012*Female + year_2013*Female + year_2014*Female + year_2016*Female + year_2017*Female +
...
### Formula for simcf
logit_gender_form <-  turned_out ~ pb + after_pb + compet + election_p + election_pp +
  year_2009 + year_2010 + year_2012 + year_2013 + year_2014 +  year_2016 + year_2017 +
  race_B + race_A + race_H + race_U + 
  Female*after_pb +
  year_2009*Female + year_2010*Female  + year_2012*Female + year_2013*Female + year_2014*Female + year_2016*Female + year_2017*Female +
...
logit_educ_simcf <-  turned_out ~ pb + after_pb + compet + election_p + election_pp +
  year_2009 + year_2010  + year_2012 + year_2013 + year_2014 +  year_2016 + year_2017 +
  race_B + race_A + race_H + race_U + 
  Female + age + I(age^2) + I(age_at_vote < 18) + 
  medhhinc_10k + college_pct + majmatch +
  college_pct*after_pb +
  college_pct*year_2009 + college_pct*year_2010 +  college_pct*year_2012 + college_pct*year_2013 + college_pct*year_2014 + college_pct*year_2016 + college_pct*year_2016 +
  (1 | VANID) + (1 | NYCCD)

lme_educ_simcf <- glmer(logit_educ_simcf, data = pb_long, family = binomial(), nAGQ = 0)    #start = list(fixef = bas_log$coefficients),

### Formula for simcf
logit_educ_form <-  turned_out ~ pb + after_pb + compet + election_p + election_pp +
  year_2009 + year_2010 +  year_2012 + year_2013 + year_2014 +  year_2016 + year_2017 +
  race_B + race_A + race_H + race_U + 
  Female + age + I(age^2) + I(age_at_vote < 18) + 
  medhhinc_10k + college_pct + majmatch +
...
logit_income_simcf <- turned_out ~ pb + after_pb + compet + election_p + election_pp +
  year_2009 + year_2010 + year_2012 + year_2013 + year_2014 +  year_2016 + year_2017 +
  race_B + race_A + race_H + race_U + 
  Female + age + I(age^2) + I(age_at_vote < 18) + 
  medhhinc_10k + college_pct + majmatch +
...
### Formula for simcf
logit_income_form <-  turned_out ~ pb + after_pb + compet + election_p + election_pp +
  year_2009 + year_2010 + year_2012 + year_2013 + year_2014 +  year_2016 + year_2017 +
  race_B + race_A + race_H + race_U + 
  Female + age + I(age^2) + I(age_at_vote < 18) + 
  medhhinc_10k + college_pct + majmatch +
...
logit_youth_simcf <- turned_out ~ pb + after_pb*youth + race_B + race_A + race_H + race_U +
  year_2009*youth + year_2010*youth + year_2012*youth + year_2013*youth + year_2014*youth + year_2016*youth + year_2017*youth +
  compet + election_p + election_pp + Female + age + I(age^2) + I(age_at_vote < 18) + medhhinc_10k + college_pct + majmatch  + (1 | VANID) + (1 | NYCCD)
...
logit_youth_form <-  turned_out ~ pb + after_pb*youth + race_B + race_A + race_H + race_U +
  year_2009*youth + year_2010*youth + year_2012*youth + year_2013*youth + year_2014*youth + year_2016*youth + year_2017*youth +
  compet + election_p + election_pp + Female + age + I(age^2) + I(age_at_vote < 18) + medhhinc_10k + college_pct + majmatch
...
logit_youth18p_simcf <- turned_out ~ pb + after_pb*youth + race_B + race_A + race_H + race_U +
  year_2009*youth + year_2010*youth + year_2012*youth + year_2013*youth + year_2014*youth + year_2016*youth + year_2017*youth +
  compet + election_p + election_pp + age + medhhinc_10k + majmatch  + (1 | VANID) + (1 | NYCCD)
...
logit_youth18p_form <-   turned_out ~ pb + after_pb*youth + race_B + race_A + race_H + race_U +
  year_2009*youth + year_2010*youth +  year_2012*youth + year_2013*youth + year_2014*youth + year_2016*youth + year_2017*youth +
  compet + election_p + election_pp + age + medhhinc_10k + majmatch
...
nscen_race <- nscen <- length(unique(pb_long_orig$Race))*2
xhyp <- cfMake(logit_race_form, pb_long, nscen = nscen, f = "min")

simyear <- "2016"
mean_compet <-mean(pb_long_orig$compet[pb_long_orig$election_type=="g" & pb_long_orig$year == simyear], na.rm = T)
for (i in 1:nscen){
  xhyp <- cfChange(xhyp, "age", x = mean(pb_long_orig$age), xpre = mean(pb_long_orig$age), scen = i)
  xhyp <- cfChange(xhyp, "medhhinc_10k", x = mean(pb_long_orig$medhhinc_10k), xpre = mean(pb_long_orig$medhhinc_10k), scen = i)
  xhyp <- cfChange(xhyp, "white", x = mean(pb_long_orig$white[pb_long_orig$Race == "W"]), xpre = mean(pb_long_orig$white[pb_long_orig$Race == "W"]), scen = i)
  xhyp <- cfChange(xhyp, "majmatch", x = mean(pb_long_orig$majmatch[pb_long_orig$Race == "W"]), xpre = mean(pb_long_orig$majmatch[pb_long_orig$Race == "W"]), scen = i)
  xhyp <- cfChange(xhyp, paste0("year_", simyear), x = 1, xpre = 1, scen = i)
  xhyp <- cfChange(xhyp, "age_at_vote", x = mean(pb_long_orig$age_at_vote), xpre = mean(pb_long_orig$age_at_vote), scen = i)
  xhyp <- cfChange(xhyp, "Female", x = mean(pb_long_orig$Female), xpre = mean(pb_long_orig$Female), scen = i)
  xhyp <- cfChange(xhyp, "college_pct", x = mean(pb_long_orig$college_pct), xpre = mean(pb_long_orig$college_pct), scen = i)
  xhyp <- cfChange(xhyp, "pb", x = 0, xpre = 0, scen = i)
  xhyp <- cfChange(xhyp, "compet", x = mean_compet, xpre = mean_compet, scen = i)
}
...
for (i in c(2,7)){
  ...
  xhyp <- cfChange(xhyp, "majmatch", x = mean(pb_long_orig$majmatch[pb_long_orig$Race == "B"]), xpre =  mean(pb_long_orig$majmatch[pb_long_orig$Race == "B"]), scen = i)
  xhyp <- cfChange(xhyp, "white", x = mean(pb_long_orig$white[pb_long_orig$Race == "B"]),  mean(pb_long_orig$majmatch[pb_long_orig$Race == "B"]), scen = i)
}
for (i in c(3,8)){
  xhyp <- cfChange(xhyp, "race_H", x = 1, xpre = 1, scen = i)
  xhyp <- cfChange(xhyp, "majmatch", x = mean(pb_long_orig$majmatch[pb_long_orig$Race == "H"]), xpre =  mean(pb_long_orig$majmatch[pb_long_orig$Race == "H"]), scen = i)
  xhyp <- cfChange(xhyp, "white", x = mean(pb_long_orig$white[pb_long_orig$Race == "H"]),  mean(pb_long_orig$majmatch[pb_long_orig$Race == "H"]), scen = i)
}
for (i in c(4,9)){
  xhyp <- cfChange(xhyp, "race_A", x = 1, xpre = 1, scen = i)
  xhyp <- cfChange(xhyp, "majmatch", x = mean(pb_long_orig$majmatch[pb_long_orig$Race == "A"]), xpre =  mean(pb_long_orig$majmatch[pb_long_orig$Race == "A"]), scen = i)
  xhyp <- cfChange(xhyp, "white", x = mean(pb_long_orig$white[pb_long_orig$Race == "A"]),  mean(pb_long_orig$majmatch[pb_long_orig$Race == "A"]), scen = i)
}
for (i in c(5,10)){
  xhyp <- cfChange(xhyp, "race_U", x = 1, xpre = 1, scen = i)
  xhyp <- cfChange(xhyp, "majmatch", x = mean(pb_long_orig$majmatch[pb_long_orig$Race == "U"]), xpre =  mean(pb_long_orig$majmatch[pb_long_orig$Race == "U"]), scen = i)
  xhyp <- cfChange(xhyp, "white", x = mean(pb_long_orig$white[pb_long_orig$Race == "U"]),  mean(pb_long_orig$majmatch[pb_long_orig$Race == "U"]), scen = i)
}
...
preds_race %>% dplyr::select(after_pb, Race, pe, lower, upper) %>% 
  ...
  coord_flip() +
  theme_minimal()
 ggsave(paste0(path, "byrace.pdf"), width = 5, height = 4)
...
nscen <- length(unique(pb_long_orig$majmatch))*2
...
preds_majmatch %>% dplyr::select(after_pb, majmatch, pe, lower, upper) %>% 
  ...
  coord_flip() +
  theme_minimal()
ggsave(paste0(path, "bymajmatch.pdf"), width = 5, height = 4)
...
nscen <- length(unique(pb_long_orig$Female))*2
...
preds_gender %>% dplyr::select(after_pb, Female, pe, lower, upper) %>% 
  ...
  coord_flip() +
  theme_minimal()
ggsave(paste0(path, "bygender.pdf"), width = 5, height = 4)


### Educ in 2016 --------------------------------------------------------------------------------------------------
educ_levels <- quantile(pb_long_orig$college_pct, probs = c(.25,.75))
...
preds_educ %>% dplyr::select(after_pb, college_pct, pe, lower, upper) %>% 
  ...
  coord_flip() +
  theme_minimal()
ggsave(paste0(path, "byeduc.pdf"), width = 5, height = 4)


### Income in 2016 --------------------------------------------------------------------------------------------
income_levels <- quantile(pb_long_orig$medhhinc_10k, probs = c(.25, .75))
...
preds_income %>% dplyr::select(after_pb, medhhinc_10k, pe, lower, upper) %>% 
  ...
  coord_flip() +
  theme_minimal()
ggsave(paste0(path, "byincome.pdf"), width = 5, height = 4)
...
preds_youth18p %>% dplyr::select(after_pb, youth, pe, lower, upper) %>% 
  ...
  coord_flip() +
  theme_minimal()
ggsave(paste0(path, "yyouth_only18+.pdf"), width = 5, height = 4)
...
ggsave(paste0(path, "group_fds.pdf"), width = 6.5, height = 5.5)
...
xhyp_update <- function(cf, simyear, oldsimyear){
  for (i in 1:nrow(cf$x)){
    ...
    cf <- cfChange(cf, "compet", x = mean_compet_17, xpre = mean_compet_17, scen = i)
  }
  cf
}
...
simyear <- "2017"
sims <- 10000
mean_compet_17 <-mean(pb_long_orig$compet[pb_long_orig$election_type=="g" & pb_long_orig$year == 2017], na.rm = T)
...
ggplot(preds_fd_plot_2017, aes(x = group, y = pe, ymin = lower, ymax =upper, color = group, group = level)) +
  ...
  theme_minimal() +
  theme(legend.position = "none")
ggsave(paste0(path, "group_fds_2017.pdf"), width = 6.5, height = 5.5)
...
ggsave(paste0(path, "group_fds_bothyears.pdf"), width = 6.75, height = 6.5)
