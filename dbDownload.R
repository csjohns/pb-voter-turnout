dbDownload <- function(table,...){
  ...
  rs <- dbSendQuery(con, "SELECT * FROM electiondistricts;") #defines the query; this SQL here is the very basic query to pull the whole table, you can send any SQL that you like
